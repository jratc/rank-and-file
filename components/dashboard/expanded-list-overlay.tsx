                    ...
                    {currentUserId === expandedList.user_id ? (
                        <div className="mb-6 group shrink-0">
                            <div className="relative">
                                <Textarea
                                    placeholder={isPopulating ? "Building your list... jot some thoughts down about your list while we work" : "Owner's Note—what should people know about your list?"}
                                    ...
                                    className="min-h-[60px] max-h-[120px] font-medium text-[13px] resize-none border-none bg-yellow-50/80 text-yellow-900 placeholder:text-yellow-700/50 hover:bg-yellow-50 focus:bg-yellow-50 focus-visible:ring-1 focus-visible:ring-yellow-200 rounded-xl p-4 transition-all overflow-y-auto"
                                />
                            ...
                            {allComments.length > 0 && (
                                <div className="space-y-3 pt-4 mt-2">
                                    <h4 className="text-[9px] font-black uppercase tracking-widest text-slate-300 px-1">Responses</h4>
                                    <div className="space-y-3">
                                        {allComments
                                            .map((comment) => (
                                                <div key={comment.id} className="flex flex-col gap-1 group/comment pl-3 border-l-[3px] border-slate-100">
                            ...
                            {allComments.filter(c => c.user_id !== currentUserId).length > 0 && (
                                <div className="mt-4 bg-slate-50/50 border border-slate-100 rounded-2xl p-2 transition-all focus-within:ring-2 focus-within:ring-blue-100">
                                    <div className="flex gap-2 min-h-[40px]">
                                        <Textarea
                                            placeholder="Reply to thoughts..."
                                            value={replyContent}
                        ...
                        <div className="mb-6 space-y-4 shrink-0">
                            {waitingComment ? (
                                <div className="px-4 py-3 bg-yellow-50/80 rounded-xl border border-yellow-100">
                                    <h4 className="text-[9px] font-black tracking-widest uppercase text-yellow-600 mb-1">Owner's Note</h4>
                            ...
                            {/* QUICK REPLY BOX */}
                            {currentUserId && (
                                <div className="mt-4 bg-slate-50 border border-slate-100 rounded-2xl p-2 transition-all focus-within:ring-2 focus-within:ring-slate-300">
                                    <div className="flex gap-2 min-h-[40px]">
                                        <Textarea
